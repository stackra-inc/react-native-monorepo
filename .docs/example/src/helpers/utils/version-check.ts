...
export const APP_STORE_URL = "https://apps.apple.com/us/app/heroui-native/id6757860059";
 ...
 */
export async function getInfoFromPlayStore(_country = ""): Promise<AppInfoFromStore | null> {
  return null;
}
