...
const TermsAndPrivacyContent = () => {
  ...
  const handlePrivacyPress = () => Alert.alert("Privacy", "Navigate to Privacy Policy");

  return (
    <View className="flex-1 px-5 items-center justify-center">
      <View className="w-full max-w-xs gap-6">
        <ControlField isSelected={isAgreed} onSelectedChange={setIsAgreed} className="items-start">
          ...
          <View className="flex-row flex-wrap flex-1">
            ...
            <LinkButton size="sm" onPress={handleTermsPress}>
              <LinkButton.Label className="text-accent">Terms of Service</LinkButton.Label>
            </LinkButton>
