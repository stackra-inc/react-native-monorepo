  ...
  return (
    <View className="flex-1 items-center justify-center px-8">
      <View className="w-full" style={{ height: height * 0.6 }}>
        <ScrollShadow size={height * 0.1} LinearGradientComponent={LinearGradient}>
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Text className="mb-3 text-xl font-semibold text-foreground">Sed Ut Perspiciatis</Text>
            <Text className="mb-4 text-base leading-6 text-foreground">
            ...
            <Text className="mb-3 text-xl font-semibold text-foreground">Nam Libero Tempore</Text>
            <Text className="mb-4 text-base leading-6 text-foreground">
            ...
            <Text className="mb-3 text-lg font-medium text-foreground">Itaque Earum Rerum</Text>
            <Text className="mb-4 text-base leading-6 text-foreground">
            ...
            <Text className="mb-3 text-lg font-medium text-foreground">Neque Porro Quisquam</Text>
            <Text className="mb-4 text-base leading-6 text-foreground">
            ...
            <Text className="mb-4 text-base leading-6 text-foreground">
              ...
              mollit anim id est laborum. Et harum quidem rerum facilis est et expedita distinctio.
              Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus
              id quod maxime placeat facere possimus.
            </Text>

            <Text className="mb-3 text-2xl font-semibold text-foreground">Cicero's De Finibus</Text>
            <Text className="mb-4 text-base leading-6 text-foreground">
            ...
            <Text className="mb-3 text-xl font-semibold text-foreground">Final Section</Text>
      ...
      <View className="h-40 w-full">
        <ScrollShadow LinearGradientComponent={LinearGradient}>
          <FlashList
            ...
            renderItem={({ item: _item }) => <Surface variant="tertiary" className="size-32" />}
...
export default function ScrollShadowScreen() {
  return <UsageVariantFlatList data={SCROLL_SHADOW_VARIANTS} scrollEnabled={false} />;
}
